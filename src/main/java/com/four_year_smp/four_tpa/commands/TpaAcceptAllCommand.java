...
public class TpaAcceptAllCommand extends AbstractTpaCommand implements TabCompleter {
    public TpaAcceptAllCommand(LocalizationHandler localizationHandler, ITeleportManager teleportManager) {
